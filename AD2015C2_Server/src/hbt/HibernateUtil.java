...
//        	 config.addAnnotatedClass(entities.ItemOCENT.class);
//        	 config.addAnnotatedClass(entities.ItemOCENTpk.class);
        	 config.addAnnotatedClass(entities.ItemOPENT.class);
        	 config.addAnnotatedClass(entities.ItemOPENTpk.class);
//        	 config.addAnnotatedClass(entities.ItemRCCOVENT.class);
//        	 config.addAnnotatedClass(entities.ItemRCCOVENTpk.class);
        	 config.addAnnotatedClass(entities.ItemRemitoENT.class);
        	 config.addAnnotatedClass(entities.ItemRemitoENTpk.class);
//        	 config.addAnnotatedClass(entities.ItemRPCCENT.class);
//        	 config.addAnnotatedClass(entities.ItemRPCCENTpk.class);
...
//        	 config.addAnnotatedClass(entities.RemitoCCOVENT.class);
        	 config.addAnnotatedClass(entities.RemitoENT.class);
//        	 config.addAnnotatedClass(entities.RemitoProvCCENT.class);
